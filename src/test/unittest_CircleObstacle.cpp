...
public:
    const world::CircleObstacle obstacle = world::CircleObstacle(world::Vector2(0.0, 0.0), 5.0);
...
{
    ASSERT_FALSE(obstacle.collisionCheck(world::Line2(point2, point3)));
    ASSERT_FALSE(obstacle.collisionCheck(world::Line2(point4, point5)));
